...
CREATE TABLE TBL_LNF(
  ...
  LNF_ENROLL_DATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT '작성일',
  LNF_MODIFY_DATE TIMESTAMP DEFAULT NULL COMMENT '수정일',
...
CREATE TABLE TBL_COMMUNITY (
    ...
    COMMUNITY_ENROLL_DATE DATE DEFAULT (CURRENT_DATE) NOT NULL,
...
CREATE TABLE TBL_PIC (
    ...
    FILE_TYPE VARCHAR(5) CHECK(FILE_TYPE IN ('TITLE', 'BODY')) NOT NULL,
		...
		ATTACHMENT_BOARD_STATUS VARCHAR(1) DEFAULT 'Y',
...
CREATE TABLE TBL_NOTICE (
	...
	NOTICE_ENROLL_DATE TIMESTAMP DEFAULT (CURRENT_DATE) NOT NULL,
...
DOWN_ENROLL_DATE TIMESTAMP DEFAULT (CURRENT_TIMESTAMP) NOT NULL,
DOWN_MODIFY_DATE TIMESTAMP,
